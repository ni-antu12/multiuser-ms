...
export class CreateLeaderDto {
  @ApiPropertyOptional({
    description: 'UUID corto de 8 caracteres para el usuario líder. Si no se proporciona, se generará automáticamente',
    example: 'nP7vQ8rT',
    minLength: 8,
    maxLength: 8
  })
  ...
  @ApiProperty({
    description: 'RUT único del usuario líder (formato: 12345678-9)',
    example: '12345678-9'
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Email único del usuario líder',
